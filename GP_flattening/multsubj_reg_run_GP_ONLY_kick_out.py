...
import vae_reg_GP_ONLY_kick_out as vae_reg
import build_model_recons_OLD as recon
...
parser.add_argument('--gp_cutoff', type=float, metavar='N', default=1e-4, \
help='Posterior mean variance cutoff for dropping a GP covariate.')
...
if __name__ == "__main__":
	...
	mll_scale = args.mll_scale, l1_scale=args.l1_scale, gp_cutoff=args.gp_cutoff)
