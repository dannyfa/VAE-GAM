...
Only difference between this script and multsubj_reg_run.py is that it DOES NOT allow
user to specify a initial map for the task contrast. In this case, all covariate maps
are random initialized.
"""
