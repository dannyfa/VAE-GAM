...
To train model, plot GPs or create brain maps use multsubj_reg_run_noinit.py as detailed in README.

Only difference between this module and vae_reg_GP.py is that it DOES not utilize pre-specified initial map
for the task covariate.
"""
